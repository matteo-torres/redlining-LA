...
| Data | Citation | Link |
|------|----------|------|
| EJScreen | U.S. Environmental Protection Agency (EPA), 2023. EJScreen Technical Documentation. | www.epa.gov/EJScreen |
| HOLC Redlining | Robert K. Nelson, LaDale Winling, Richard Marciano, Nathan Connolly, et al., “Mapping Inequality,” American Panorama, ed. Robert K. Nelson and Edward L. Ayers, accessed October 17, 2023. | https://dsl.richmond.edu/panorama/redlining/data |
| Biodiversity Observations | Ellis-Soto, D., Chapman, M., & Locke, D. H. (2023). Historical redlining is associated with increasing geographical disparities in bird biodiversity sampling in the United States. Nature Human Behaviour, 1-9. | https://www.gbif.org |